...
TARGET_BOOTLOADER_BOARD_NAME := nobleltespr
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset  0x01000000 --dt device/samsung/nobleltespr/dtb --tags_offset 0x0000100
...
TARGET_RECOVERY_INITRC := device/samsung/nobleltespr/init.rc

# Kernel Configs
#TARGET_KERNEL_SOURCE := kernel/samsung/nobleltespr
...
#VARIANT_CONFIG :=
#TIMA_DEFCONFIG :=
TARGET_PREBUILT_KERNEL := device/samsung/nobleltespr/kernAl
